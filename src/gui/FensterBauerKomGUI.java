...
public class FensterBauerKomGUI {
    ...
    private void initGUI() 
    {
        ...
        //Fenster erzeugen
        JFrame erstesFenster = FensterBauerKom.getFenster("1. Fenster", g, pos, true, true, Stil.MOTIF);
        ...
        JFrame zweitesFenster = 
            FensterBauerKom.getFenster("2. Fenster", viertelBildschirm, new Point(50,20), false, false, Stil.JAVA);
